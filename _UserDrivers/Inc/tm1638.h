...
*/
uint8_t TM1638_SetDisplay(TM1638_STB_t *tm, uint8_t onoff, uint8_t brightness);

/*
reset Seg1 to Seg10.
Clear all digits and leds
*/
void TM1638_ResetSegments(TM1638_STB_t *tm);
...
Address increment mode.
    ...
    address: 0 to 15
*/
uint8_t TM1638_SetSegments_Seg1ToSeg10(TM1638_STB_t *tm, uint8_t segments[], uint8_t length, uint8_t address);
...
*/
uint8_t TM1638_SetSegments_Seg1ToSeg8_OverWriteSeg9Seg10(TM1638_STB_t *tm, uint8_t segments[], uint8_t length, uint8_t pos);
...
*/
uint8_t TM1638_SetSegments_Seg1ToSeg8_KeepSeg9Seg10(TM1638_STB_t *tm, uint8_t segments[], uint8_t length, uint8_t pos);
...
Write SRAM data in a fixed address mode
    ...
    address: 0 to 15
*/
uint8_t TM1638_SetSegments_FixedAddress(TM1638_STB_t *tm, uint8_t data, uint8_t address);
...
*/
void TM1638_SetLeds_Seg9(TM1638_STB_t *tm, uint8_t data);
...
*/
void TM1638_SetLeds_Seg9Seg10(TM1638_STB_t *tm, uint16_t data);
...
key:    4-Byte
*/
void TM1638_GetButtons_K1K2K3(TM1638_STB_t *tm, uint8_t *key);
...
key:    1-Byte
*/
void TM1638_GetButtons_K3(TM1638_STB_t *tm, uint8_t *key);
