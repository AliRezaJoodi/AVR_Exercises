...
//    sprintf(txt, "0x%02X\r", key[0]); puts(txt);
    ...
    TM1637_WriteDisplay_AutoIncr(&tm1, seg1, 6, 0);
    TM1637_WriteDisplay_AutoIncr(&tm2, seg2, 6, 0);
    delay_ms(1000);

    TM1637_WriteDisplay_Fixed(&tm1, seg1[5], 2); delay_ms(1000);
    TM1637_ClearDisplay(&tm1); delay_ms(1000);
    TM1637_WriteDisplay_Fixed(&tm1, seg1[2], 5); delay_ms(1000);
    ...
    TM1637_Write4Digits(&tm2, seg1); delay_ms(1000);

    while(1){
//        sprintf(txt, "0x%02X\r", key[0]); puts(txt);
        TM1637_WriteDisplay_AutoIncr(&tm1, seg1, 6, 0); delay_ms(500);
        TM1637_WriteDisplay_AutoIncr(&tm2, seg2, 6, 0); delay_ms(500);
