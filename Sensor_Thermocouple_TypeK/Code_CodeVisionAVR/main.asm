...
; 0001 00B5 int32_t t0 = 0;
; 0001 00B6 int32_t result = 0;
; 0001 00B7 
; 0001 00B8 if(uv <= TC_K_Table10C[0]){
	CALL __PUTPARD2
	SBIW R28,16
	LDI  R24,16
	LDI  R26,LOW(0)
...
; 0001 00BA }
; 0001 00BB 
; 0001 00BC if(uv >= TC_K_Table10C[TC_K_TABLE_SIZE-1]){
_0x20004:
...
; 0001 00BE }
; 0001 00BF 
; 0001 00C0 for(i = 0; i < (TC_K_TABLE_SIZE-1); i++){
_0x20005:
	__GETWRN 16,17,0
_0x20007:
	__CPWRN 16,17,164
	BRLT PC+2
	RJMP _0x20008
; 0001 00C1 if(uv < TC_K_Table10C[i+1]){
	CALL SUBOPT_0x4
	CALL SUBOPT_0x3
	CALL __CPD21
	BRLT PC+2
	RJMP _0x20009
; 0001 00C2 uv0 = TC_K_Table10C[i];
	CALL SUBOPT_0x5
	__PUTD1S 14
; 0001 00C3 uv1 = TC_K_Table10C[i+1];
	CALL SUBOPT_0x4
	CALL __GETD1PF
	__PUTD1S 10
; 0001 00C4 
; 0001 00C5 t0 = TC_K_TEMP_MIN + ((int32_t)i * 10);
	...
	__PUTD1S 6
; 0001 00C6 
; 0001 00C7 result = (t0 + (((uv - uv0) * 10) / (uv1 - uv0)));
	__GETD2S 14
	__GETD1S 18
	CALL __SUBD12
	__GETD2N 0xA
	...
	CALL __ADDD12
	CALL SUBOPT_0x7
; 0001 00C8 return (int16_t)result;
	LDD  R30,Y+2
	LDD  R31,Y+2+1
	RJMP _0x20C0005
; 0001 00C9 }
...
; 0001 00D4 int32_t uv0 = 0;
; 0001 00D5 int32_t uv1 = 0;
; 0001 00D6 int32_t duv = 0;
; 0001 00D7 int32_t result = 0;
; 0001 00D8 
; 0001 00D9 // Clamp temperature to table limits (-270°C to +1370°C)
; 0001 00DA if (temp <= -270){
	ST   -Y,R27
	ST   -Y,R26
	SBIW R28,16
	LDI  R24,16
...
;	result -> Y+6
	...
	CPC  R31,R27
	BRLT _0x2000B
; 0001 00DB return TC_K_Table10C[0];
	LDI  R30,LOW(_TC_K_Table10C_G001*2)
	LDI  R31,HIGH(_TC_K_Table10C_G001*2)
	CALL __GETD1PF
	RJMP _0x20C0004
...
_0x2000B:
	...
	CPC  R27,R30
	BRLT _0x2000C
; 0001 00DF return TC_K_Table10C[TC_K_TABLE_SIZE - 1];
	__POINTW1FN _TC_K_Table10C_G001,656
	CALL __GETD1PF
	RJMP _0x20C0004
; 0001 00E0 }
; 0001 00E1 
; 0001 00E2 // Compute table index (each entry represents 10°C)
; 0001 00E3 index = (temp + 270) / 10;
_0x2000C:
	LDD  R26,Y+22
	LDD  R27,Y+22+1
	SUBI R26,LOW(-270)
	...
	MOVW R16,R30
; 0001 00E4 
; 0001 00E5 // Base temperature for this table cell
; 0001 00E6 t0 = (index * 10) - 270;
	LDI  R26,LOW(10)
	LDI  R27,HIGH(10)
	CALL __MULW12
	SUBI R30,LOW(270)
	...
	MOVW R18,R30
; 0001 00E7 
; 0001 00E8 // Lookup microvolt values
; 0001 00E9 uv0 = TC_K_Table10C[index];       // µV at t0
	CALL SUBOPT_0x5
	__PUTD1S 18
; 0001 00EA uv1 = TC_K_Table10C[index + 1];   // µV at t0 + 10°C
	CALL SUBOPT_0x4
	CALL __GETD1PF
	__PUTD1S 14
; 0001 00EB 
; 0001 00EC // If temperature exactly matches a 10°C grid point
; 0001 00ED if (temp == t0){
	LDD  R26,Y+22
	LDD  R27,Y+22+1
	CP   R18,R26
	CPC  R19,R27
	BRNE _0x2000D
; 0001 00EE return uv0;
	__GETD1S 18
	RJMP _0x20C0004
; 0001 00EF }
; 0001 00F0 
; 0001 00F1 // Linear interpolation (integer math, no floats)
; 0001 00F2 dt  = temp - t0;   // offset from base temperature (0..10)
_0x2000D:
	LDD  R30,Y+22
	LDD  R31,Y+22+1
	SUB  R30,R18
	SBC  R31,R19
	MOVW R20,R30
; 0001 00F3 duv = uv1 - uv0;   // delta µV between table entries
	__GETD2S 18
	__GETD1S 14
	CALL __SUBD12
	__PUTD1S 10
; 0001 00F4 
; 0001 00F5 // Return interpolated microvolt value
; 0001 00F6 result = uv0 + ((duv * dt) / 10);
	MOVW R30,R20
	__GETD2S 10
	CALL __CWD1
	CALL __MULD12
